...
-- \i C:/Users/MAYANK YADAV/Netflix/NETFLIX_DATA_CLEANING.sql


-- Step 1 - Creating a new database 'netflix'

DROP DATABASE netflix;
CREATE DATABASE netflix WITH OWNER mayank;
...
\copy raw_titles(index,id,title,type,release_year,age_certification,runtime,genres,production_countries,seasons,imdb_id,imdb_score,imdb_votes) FROM 'C:\Users\MAYANK YADAV\Netflix\archive\raw_titles.csv' WITH DELIMITER ',' CSV HEADER;

\copy raw_credits(index,person_id,id,name,character,role) FROM 'C:\Users\MAYANK YADAV\Netflix\archive\raw_credits.csv' WITH DELIMITER ',' CSV HEADER;
...
\copy titles TO 'C:/Users/MAYANK YADAV/Netflix/titles_cleaned.csv' DELIMITER ',' CSV HEADER;
\copy credits TO 'C:/Users/MAYANK YADAV/Netflix/credits_cleaned.csv' DELIMITER ',' CSV HEADER;
