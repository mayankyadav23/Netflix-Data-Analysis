...
-- \i C:/Users/MAYANK YADAV/Netflix/NETFLIX_DATA_NORMALIZATION.sql
...
-- \COPY (SELECT * FROM netflix_table) TO 'C:/Users/MAYANK YADAV/Netflix/netflix_joined_data.csv' DELIMITER ',' CSV HEADER;

-- \COPY (SELECT * FROM country) TO 'C:/Users/MAYANK YADAV/Netflix/country.csv' DELIMITER ',' CSV HEADER;
